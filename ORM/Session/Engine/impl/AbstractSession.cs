...
using DbColumn = ORM.Result.DbColumn;


namespace ORM.Session.Engine.impl
{
    public abstract class AbstractSession : ISession, IDisposable, IStateHandleable
    {
        private readonly ILogger _logger = new Logger(typeof(AbstractSession));
        ...
        protected AbstractSession(string connectionString)
        {
            _isOpen = false;
        ...
        {
            SessionStateHandler.ToHandleSessionState(this).Close(this);
        }
        
        public ISession Open(int connectionTimeout = 30)
        {
            SessionStateHandler.ToHandleSessionState(this).Open(this, connectionTimeout);
            return this;
        }
        ...
        public abstract bool CanHandle(DatabaseEngine databaseEngine);
